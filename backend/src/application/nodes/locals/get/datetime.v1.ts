...
export const LOCALS_GET_DATETIME_V1: NodeImplementation = {
  def: {
    nodeType: 'locals.get.datetime',
    title: '读取局部变量（DateTime）',
    category: 'locals',
    description: '读取 locals 中的 DateTime 变量（params.name）。',
    inputs: [],
