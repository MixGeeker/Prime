...
export const INPUTS_GLOBALS_DATETIME_V1: NodeImplementation = {
  def: {
    nodeType: 'inputs.globals.datetime',
    title: '读取全局输入（DateTime）',
    category: 'inputs',
    description: '从 inputs.globals 读取一个 DateTime（params.name）。',
    inputs: [],
